...
public class SeaAuthorizationServerConfigurer extends AuthorizationServerConfigurerAdapter {
    ...
    //客户端从认证服务器获取令牌的时候，必须使用client_id为sea，client_secret为123456的标识来获取
    @Override
